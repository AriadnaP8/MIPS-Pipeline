...
HD_PWD='D:/Faculta/AN2/Sem 2/AC/ProiectFinalMipsPipeline/ProiectFinalMipsPipeline.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log lab7_4.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source lab7_4.tcl
