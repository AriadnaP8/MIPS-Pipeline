...
HD_PWD='D:/Faculta/AN2/Sem 2/AC/ProiectFinalMipsPipeline/ProiectFinalMipsPipeline.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log lab7_4.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source lab7_4.tcl -notrace
